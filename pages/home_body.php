<body class="main_body">
	<?php
   	...
   	<div class="full_sep">
   		<p class="note">This will have to tell a "story". &emsp; The site "theme" should be consistant. &emsp; Perhaps an About page and this is just a general, hopefully interesting, landing page.</p>
   	</div>
    <div class="ph c1">
